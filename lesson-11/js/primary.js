...
function townPreston(jsonObj) {
  ...
  townRain.textContent =
    "Average Precipitation: " + towns[6].averageRainfall + '"';
...
function townSodaSprings(jsonObj) {
  ...
  var townRain = document.createElement("h6");
  townRain.textContent =
    "Average Precipitation: " + towns[0].averageRainfall + '"';
...
function townFishHaven(jsonObj) {
  ...
  var townRain = document.createElement("h6");
  townRain.textContent =
    "Average Precipitation: " + towns[2].averageRainfall + '"';
